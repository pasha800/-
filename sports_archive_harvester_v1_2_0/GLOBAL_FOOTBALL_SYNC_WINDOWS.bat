...
setlocal
cd /d "%~dp0"
title Sports Archive Harvester v1.3.1 - GLOBAL CLUB FOOTBALL SYNC
...
echo =====================================================================
echo GLOBAL CLUB FOOTBALL SYNC v1.3.1
...
echo Clubs, national teams, leagues and cups are collected.
