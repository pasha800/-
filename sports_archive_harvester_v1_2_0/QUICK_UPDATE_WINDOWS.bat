...
setlocal
cd /d "%~dp0"
title Sports Archive Harvester v1.3.2 - QUICK GLOBAL UPDATE
...
echo =====================================================================
echo QUICK GLOBAL UPDATE v1.3.2
...
echo 3) Resilient media downloads with Wikimedia thumbnails and rate limiting
echo Images stay outside SQLite and are linked by local relative paths.
echo =====================================================================
python -u media_download_fix.py quick --enrich-limit 20
set NATIONAL_CODE=%ERRORLEVEL%
echo.
python -u global_football_sync_v3.py --mode quick
set CLUB_CODE=%ERRORLEVEL%
echo.
python -u enrich_players_media_fixed.py --limit 20
